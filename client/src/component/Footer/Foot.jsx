export function Foot() {
    return (
      <footer className="w-full static bottom-0 bg-gray-50 ">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">

          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
              <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">

                  <p className="font-bold text-xl text-inherit flex items-center justify-center mr-7">RegiSphere</p>
                  <p className="py-2 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in more than 10 global and inclusive registration system. Have any query ?</p>
              ...
              <div className="lg:mx-auto text-left ">
                  <h4 className="text-lg text-gray-900 font-medium mb-7">Regisphere</h4>
          ...
          <div className="py-7 border-t border-gray-200">
              <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                  <span className="text-sm text-gray-500 ">©<a href="/">RegiSphere</a> 2025, All rights reserved.</span>
